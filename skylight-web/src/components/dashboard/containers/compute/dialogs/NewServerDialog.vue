        ...
        <v-card>
            <v-card-text height="300" class="pa-0">
                <v-stepper elevation="0" vertical height="510">
                    ...
                    <v-stepper-content step="1">
                        <v-row >
                            ...
                            <v-col cols="6">
                                ...
                                <v-select :items="dialog.images" label="镜像" density='compact' item-text="name" item-value="id"
                            ...
                            <v-col cols="6">
                                ...
                                <v-select clearable density='compact' :items="dialog.ports" label="端口" item-text="name" item-value="id"
                            ...
                            <v-col cols="4">
                                <v-select hide-details :disabled="!dialog.useBdm" :items="dialog.volumeTypes"
                                    clearable label="卷类型" density='compact' item-text="name" item-value="id"
                    ...
                    <v-stepper-step step="2" color="success" editable="editable"><h2>{{ $t('security') }}</h2></v-stepper-step>
