    ...
    <v-dialog v-model="display" width="800">
        <v-card>
            ...
            <v-card-text>
                <v-row>
                    <v-col>
                        <v-text-field label="*名字" placeholder="请输入网络名" v-model="dialog.name"></v-text-field>
                    </v-col>
                ...
                <v-row>
                    <v-col cols="6">
                        <v-select dense outlined hide-details :items="dialog.netTypes" clearable label="网络类型"
                    ...
                    <v-col cols="6">
                        <v-text-field hide-details label="Segment ID" placeholder="请输入segment ID"
                            v-model="dialog.params.segId" dense outlined></v-text-field>
                    </v-col>
                    <v-col cols="6">
                        <v-text-field hide-details label="dnsDomain" placeholder="请输入dnsDomain"
                            v-model="dialog.params.dnsDomain" dense outlined> </v-text-field>
                    </v-col>
                    <v-col cols="6">
                    ...
                    <v-col cols="6">
                        <v-select :items="dialog.qosPolices" clearable label="QoS规则" dense outlined
