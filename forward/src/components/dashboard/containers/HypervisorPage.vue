...
<v-row >
  ...
  <v-col cols="6" lg="2" md="4" sm="4">
    <v-sheet elevation="2" class="pa-4 text-center">
      <v-progress-circular rotate="360" size="100" width="10" :value="table.statistics.count * 100 / table.items.length" color="teal lighten-2">
  ...
  <v-col cols="6" lg="2" md="4" sm="4">
    <v-sheet elevation="2" class="pa-4 text-center" height="100%">
      <v-avatar color="blue lighten-3" size="90"><span class="white--text">{{I18N.t('instance')}}<br>{{table.statistics.running_vms}}</span></v-avatar>
    </v-sheet>
  </v-col>
  <v-col cols="6" lg="2" md="4" sm="4">
    <v-sheet elevation="2" class="pa-4 text-center" height="100%">
      <v-avatar color="indigo lighten-3" size="90"><span class="white--text">workload<br>{{table.statistics.current_workload}}</span></v-avatar>
    </v-sheet>
  </v-col>
      ...
      <v-card-text>
        <v-row>
          <v-col>
            ...
            <v-btn class="mx-1" small color="info" v-on:click="table.tenantUsageDialog.open()">{{ I18N.t('tenantUsage') }}</v-btn>
          </v-col>
          <v-col>
...
// import ServerDataTable from '@/assets/tables.js'
